        ...
        for (let i = 0; i < postsData.length; i++) {
            ...
            <section class="home-post">
                        ...
                        <section class="post-edit">
                            ...
                            <a href="./post_detail.html?accountName=${item.author.accountname}" tabindex="1">
                                </a>
                                <div class="post-icon">
                                    ...
                                    <a class="btn-comment" href="./post_detail.html?accountName=${item.author.accountname}" tabindex="1">
