        ...
        for (let i = 0; i < resJson.posts.length; i++) {
            ...
            <section class="home-post">
                        ...
                        <section class="user-follow">
                            ...
                            <a class="profile-img img-cover" href="./profile_info.html?accountName=${resJson.posts[i].author.accountname}" tabindex="1">
                                <img src="${resJson.posts[i].author.image}" alt="프로필사진">
                            </a>
                            <a class="user-info" href="./profile_info.html?accountName=${resJson.posts[i].author.accountname}" tabindex="1">
                        ...
                        <section class="post-edit">
                            ...
                            <a href="./post_detail.html?accountName=${resJson.posts[i].author.accountname}" tabindex="1">
                                ...
                                <div class="post-icon">
                                    ...
                                    </svg><span class="cnt">${resJson.posts[i].heartCount}</span>
                                    </button>
                                    <a class="btn-comment" href="./post_detail.html?accountName=${resJson.posts[i].author.accountname}" tabindex="1">
